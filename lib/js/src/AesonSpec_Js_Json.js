...
var Aeson_Js_Json_decode = require("bs-aeson/lib/js/src/Aeson_Js_Json_decode.js");
var Aeson_Js_Json_encode = require("bs-aeson/lib/js/src/Aeson_Js_Json_encode.js");

function decodeSampleUnsafe(decode, json) {
  return /* record */[
          /* seed */Aeson_Js_Json_decode.field("seed", Aeson_Js_Json_decode.$$float, json),
          /* samples */Aeson_Js_Json_decode.field("samples", (function (param) {
                  return Aeson_Js_Json_decode.list((function (a) {
                                return Aeson_Js_Json_decode.unwrapResult(Curry._1(decode, a));
                              }), param);
                }), json)
        ];
}
...
function decodeSample(decode, json) {
  ...
  try {
    ...
    if (exn[0] === Aeson_Js_Json_decode.DecodeError) {
...
function encodeSample(encode, sample) {
  return Aeson_Js_Json_encode.object_(/* :: */[
              /* tuple */[
                "seed",
                sample[/* seed */0]
              ],
              /* :: */[
                /* tuple */[
                  "samples",
                  Aeson_Js_Json_encode.list(encode, sample[/* samples */1])
                ],
                /* [] */0
              ]
            ]);
...
function goldenSpec(decode, encode, name_of_type, json_file) {
  describe("Aeson.JsJsonSpec.goldenSpec: " + (name_of_type + (" from file '" + (json_file + "'"))), (function () {
...
function sampleGoldenSpec(decode, encode, name_of_type, json_file) {
  describe("Aeson.JsJsonSpec.sampleGoldenSpec: " + (name_of_type + (" from file '" + (json_file + "'"))), (function () {
          var json = JSON.parse(Fs.readFileSync(json_file, "utf8"));
          return Jest.test("decode then encode json_file", (function () {
...
function serverSpec(decode, encode, name_of_type, url, value) {
  ...
  describe("Aeson.JsJsonSpec.serverSpec: " + name_of_type, (function () {
          return Jest.testPromise(/* None */0, "encode, POST to server, receieve from server, decode: " + encodedString, (function () {
                        return NodeFetch(url, reqInit).then((function (response) {
                                      return response.text().then((function (text) {
                                                    return Promise.resolve(Jest.Expect[/* toEqual */12](value, Jest.Expect[/* expect */0](Aeson_Js_Json_decode.unwrapResult(Curry._1(decode, JSON.parse(text))))));
                                                  }));
                                    }));
                      }));
        }));
...
function sampleServerSpec(decode, encode, name_of_type, url, values) {
  ...
  var encodedString = JSON.stringify(Aeson_Js_Json_encode.list(encode, values));
  var reqInit = Bs_node_fetch.RequestInit[/* make */0](/* Some */[/* Post */2], /* Some */[headers], /* Some */[encodedString], /* None */0, /* None */0, /* Some */[/* CORS */3], /* None */0, /* None */0, /* None */0, /* None */0, /* None */0)(/* () */0);
  describe("Aeson.JsJsonSpec.sampleServerSpec: " + name_of_type, (function () {
          return Jest.testPromise(/* None */0, "encode json_file, POST encoded to server, receieve response from server, decode response", (function () {
                        return NodeFetch(url, reqInit).then((function (response) {
                                      return response.text().then((function (text) {
                                                    return Promise.resolve(Jest.Expect[/* toEqual */12](values, Jest.Expect[/* expect */0](Aeson_Js_Json_decode.list((function (a) {
                                                                              return Aeson_Js_Json_decode.unwrapResult(Curry._1(decode, a));
                                                                            }), JSON.parse(text)))));
                                                  }));
                                    }));
...
function sampleGoldenAndServerSpec(decode, encode, name_of_type, url, json_dir) {
  ...
  return $$Array.iter((function (json_file) {
                ...
                if (match.tag) {
                  ...
                  var sample = match[0];
                  describe("Aeson.JsJsonSpec.sampleGoldenAndServerSpec: " + (name_of_type$1 + (" from file '" + (json_file$1 + "'"))), (function () {
                          Jest.test("decode then encode json_file", (function () {
                          ...
                          var encodedString = JSON.stringify(Aeson_Js_Json_encode.list(encode$1, sample[/* samples */1]));
                          var reqInit = Bs_node_fetch.RequestInit[/* make */0](/* Some */[/* Post */2], /* Some */[headers], /* Some */[encodedString], /* None */0, /* None */0, /* Some */[/* CORS */3], /* None */0, /* None */0, /* None */0, /* None */0, /* None */0)(/* () */0);
                          return Jest.testPromise(/* None */0, "encode json_file, POST encoded to server, receieve response from server, decode response", (function () {
                                        return NodeFetch(url$1, reqInit).then((function (response) {
                                                      return response.text().then((function (text) {
                                                                    return Promise.resolve(Jest.Expect[/* toEqual */12](sample[/* samples */1], Jest.Expect[/* expect */0](Aeson_Js_Json_decode.list((function (a) {
                                                                                              return Aeson_Js_Json_decode.unwrapResult(Curry._1(decode$1, a));
                                                                                            }), JSON.parse(text)))));
                                                                  }));
                                                    }));
                                      }));
...
function decodeIntWithResult(json) {
  return Aeson_Js_Json_decode.wrapResult(Aeson_Js_Json_decode.$$int, json);
}
