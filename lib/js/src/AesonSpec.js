...
function sampleGoldenSpec(decode, encode, name_of_type, json_file) {
  describe("AesonSpec.sampleGoldenSpec: " + (name_of_type + (" from file '" + (json_file + "'"))), (function () {
          var json = JSON.parse(Fs.readFileSync(json_file, "utf8"));
...
function serverSpec(decode, encode, name_of_type, url, value) {
  ...
  var reqInit = Bs_node_fetch.RequestInit[/* make */0](/* Post */2, Js_primitive.some(headers), Js_primitive.some(encodedString), undefined, undefined, /* CORS */3, undefined, undefined, undefined, undefined, undefined)(/* () */0);
  describe("AesonSpec.serverSpec: " + name_of_type, (function () {
          return Jest.testPromise("encode, POST to server, receieve from server, decode: " + encodedString, undefined, (function () {
...
function sampleServerSpec(decode, encode, name_of_type, url, values) {
  ...
  var reqInit = Bs_node_fetch.RequestInit[/* make */0](/* Post */2, Js_primitive.some(headers), Js_primitive.some(encodedString), undefined, undefined, /* CORS */3, undefined, undefined, undefined, undefined, undefined)(/* () */0);
  describe("AesonSpec.sampleServerSpec: " + name_of_type, (function () {
          return Jest.testPromise("encode json_file, POST encoded to server, receieve response from server, decode response", undefined, (function () {
                        return NodeFetch(url, reqInit).then((function (response) {
                                      return response.text().then((function (text) {
...
function sampleGoldenAndServerSpec(decode, encode, name_of_type, url, json_dir) {
  ...
  return $$Array.iter((function (json_file) {
                ...
                if (match.tag) {
                  ...
                  var sample = match[0];
                  describe("AesonSpec.sampleGoldenAndServerSpec: " + (name_of_type$1 + (" from file '" + (json_file$1 + "'"))), (function () {
