...
var Aeson_json = require("bs-aeson/lib/js/src/Aeson_json.js");
...
function decodeShape(json) {
  ...
  if (exit === 1) {
    switch (err) {
      case "Rectangle" : 
          var match = Aeson_decode.field("contents", Aeson_json.decodeArray, json);
          if (match) {
            var v = match[0];
            var exit$1 = 0;
            var v0;
          ...
          break;
      case "Square" : 
          var match$1 = Aeson_decode.field("contents", Aeson_json.decodeArray, json);
          if (match$1) {
            var v$1 = match$1[0];
            var exit$5 = 0;
            var v0$1;
          ...
          break;
      case "Triangle" : 
          var match$2 = Aeson_decode.field("contents", Aeson_json.decodeArray, json);
          if (match$2) {
            var v$2 = match$2[0];
            var exit$7 = 0;
            var v0$2;
